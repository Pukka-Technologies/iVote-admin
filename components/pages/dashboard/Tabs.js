...
const Tabs = () => {
  return (
    <section className="flex gap-x-8 py-[2em] font-text justify-center items-center">
      <article className="flex flex-col gap-3 shrink-0 bg-white w-[16em] px-[2.5em] py-[1.3em] items-center rounded-lg ">
